...
export default function ShaderAnimationComponent() {
  return (
    <div id="hero" className="relative flex h-[100svh] w-full flex-col items-center justify-center overflow-hidden rounded-xl bg-blue-700">
      <ShaderAnimation/>
